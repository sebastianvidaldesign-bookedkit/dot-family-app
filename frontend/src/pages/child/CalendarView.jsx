...
export default function CalendarView() {
  ...
  useEffect(() => {
    ...
    client.get('/period-logs/prediction').then(({ data }) => {
      setPrediction(data)
  ...
  return (
    <div className="px-4 pt-8 pb-4">
      ...
      <div className="flex items-center justify-between mb-6 px-1">
        ...
        <h2 className="text-lg font-bold text-dot-text">
      ...
      {!hasAnyData && logs.length === 0 && (
        <div className="flex flex-col items-center justify-center mt-10 text-center px-4">
          ...
          <p className="text-sm font-bold text-dot-text">Your calendar is learning</p>
          <p className="text-xs font-medium text-dot-muted mt-1 leading-relaxed">
            Add a few days and it'll start to feel like home.
          </p>
        </div>
      )}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3 className="text-base font-bold text-dot-text mb-5">
